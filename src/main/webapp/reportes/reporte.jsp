...
<head>
  ...
  <title>Estadísticas de reserva</title>
...
<body>
  ...
  <div class="container mt-4 mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2 class="mb-0">
        ...
        Estadísticas de Autores por País
      </h2>
      <div>
        <a href="<%=url%>AutoresController?op=listar" class="btn btn-outline-secondary">
        ...
        <div class="card bg-primary text-white">
          <div class="card-body text-center">
            <h6 class="card-title mb-2">
              <i class="fas fa-globe"></i> Total de Países
            </h6>
            <h2 class="mb-0" id="totalPaises">0</h2>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card bg-success text-white">
          <div class="card-body text-center">
            <h6 class="card-title mb-2">
              <i class="fas fa-users"></i> Total de Autores
            </h6>
            <h2 class="mb-0" id="totalAutores">0</h2>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card bg-info text-white">
          <div class="card-body text-center">
            <h6 class="card-title mb-2">
              <i class="fas fa-crown"></i> País con Más Autores
            </h6>
            <h2 class="mb-0" id="paisTop">-</h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header">
            <h5 class="mb-0">
              <i class="fas fa-chart-bar"></i> Autores por País (Barras)
            </h5>
          </div>
          <div class="card-body">
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header">
            <h5 class="mb-0">
              <i class="fas fa-chart-pie"></i> Distribución por País (Pastel)
            </h5>
          </div>
          <div class="card-body">
            <div class="chart-container">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h5 class="mb-0">
              <i class="fas fa-table"></i> Detalle de Autores por País
            </h5>
          </div>
          <div class="card-body">
  ...
  <thead class="table-dark">
    <tr>
      ...
      <th style="width: 25%">
        <i class="fas fa-user-tie"></i> Guía
      </th>
    </tr>
  </thead>
  <tbody>
...
const reporteManager = {
 ...
 // ==============================
 cargarTablaReservas() {
     const fetchUrl = '<%=url%>reporteControllers?op=reporteToursGuia';
     ...
     .then(data => {
         ...
         if (!data.success || !data.data || data.data.length === 0) {
             tbody.innerHTML = `
                 <tr>
                     <td colspan="5" class="text-center text-muted">
                         <i class="fas fa-inbox"></i> No hay reservas registradas
                     </td>
                 </tr>`;
             return;
         }
         ...
         data.data.forEach(r => {
             html += `
                 <tr>
                     <td class="fw-bold text-center">${r.idreserva}</td>
                     <td>${r.cliente}</td>
                     <td>${r.fecha}</td>
                     <td><span class="badge bg-primary">${r.tour}</span></td>
                     <td><span class="badge bg-success">${r.guia}</span></td>
                 </tr>
             `;
         });
    ...
    cargarDatos() {
        ...
        const fetchUrl = '<%=url%>reporteControllers?op=reporteTours';
    ...
    actualizarEstadisticas(labels, values) {
        ...
        document.getElementById('totalPaises').textContent = totalPaises;
        document.getElementById('totalAutores').textContent = totalAutores;
        document.getElementById('paisTop').textContent = paisTop;
    },
    ...
    renderizarSinDatos() {
        ...
        document.getElementById('totalPaises').textContent = '0';
        document.getElementById('totalAutores').textContent = '0';
        document.getElementById('paisTop').textContent = '-';
